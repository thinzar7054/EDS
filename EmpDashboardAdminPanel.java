...
public class EmpDashboardAdminPanel extends JPanel {
    ...
    private void addEmployeeCard(EmployeeDetailsModel emp) {
        ...
        nameLabel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                EmployeeDetailsAdminView detailsView = (EmployeeDetailsAdminView) parentFrame.getPanels().get("EmployeeDetails");
    ...
    private void searchEmployees(String searchText) {
        try {
            ...
            List<EmployeeDetailsModel> filteredEmployees = allEmployees.stream()
                    .filter(emp -> emp.getEmpName().toLowerCase().contains(searchText.toLowerCase())
